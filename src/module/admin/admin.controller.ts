...
export class AdminController {
  ...
  @Post('categories')
  createCategory(@Body() createAdminDto: ProductCategory, @Req() req: Request) {
    try {
  ...
  async adminGetCategories(
    ...
    try {
      ...
      return await this.category.adminSearchCategories(
        page,
        limit,
        status,
        search,
  ...
  getMonthlyOrderData(
    ...
    return this.orderService.getOrderCountsByMonth(startDate, endDate);
  }
  ...
  async createSubCategory(
    @Body() createAdminDto: ProductSubCategory,
    @Req() req: Request,
  ) {
    try {
      const role = req['user'].role;
  ...
  async adminGetSubCategories(
    ...
    try {
      ...
      return await this.subCategory.adminSearchSubCategories(
        page,
        limit,
        status,
        search,
  ...
  async removeSubCategory(@Param('id') id: string, @Req() req: Request) {
    try {
      const role = req['user'].role;
      const userType = req['user'].sub;
  ...
  async adminFindUsers(@Req() req: Request) {
    try {
      const role = req['user'].role;
      const userType = req['user'].sub;
  ...
  async adminFindUser(@Req() req: Request, @Param('id') id: string) {
    try {
      const role = req['user'].role;
      const userType = req['user'].sub;
  ...
  async adminListVendors(
    ...
    try {
      ...
      return await this.vendorService.adminFindAll(
        page,
        limit,
        query,
        isDisabled,
  ...
  @Post('vendors/')
  async adminCreateVendors(@Req() req: Request, @Body() dto: Vendor) {
    try {
  ...
  @Delete('vendors/:id')
  async adminDeleteVendors(@Req() req: Request, @Param('id') id: string) {
    try {
      const role = req['user'].role;
      const userType = req['user'].sub;
      if (role != 'admin' || userType != 'usave_admin') {
  ...
  @Get('vendors/:id')
  async adminGetVendor(@Req() req: Request, @Param('id') id: string) {
    try {
      const role = req['user'].role;
      const userType = req['user'].sub;
      if (role != 'admin' || userType != 'usave_admin') {
  ...
  async adminListItemsByVendors(
    ...
    try {
      ...
      return await this.itemService.adminListItemByVendors(
        vendorID,
        page,
        limit,
        status,
  ...
  async adminListNewItemsByVendors(
    ...
    try {
      ...
      return await this.itemService.adminListNewItemByVendors(
        vendorID,
        page,
        limit,
      );
  ...
  async adminApproveItem(@Req() req: Request, @Param('itemID') itemID: string) {
    try {
      const role = req['user'].role;
      const userType = req['user'].sub;
      if (role != 'admin' || userType != 'usave_admin') {
  ...
  async adminGetOrderByStatusAndRange(
    ...
    try {
      ...
      return await this.orderService.getOrderByStatusAndRange(
        page,
        limit,
        status,
        startDate,
  ...
  @Post('agents/')
  async adminCreateAgents(@Req() req: Request, @Body() dto: Agent) {
    try {
      dto.password = this.password;
  ...
  @Delete('agents/id')
  async adminDeleteAgents(@Req() req: Request, @Param('id') id: string) {
    try {
      const role = req['user'].role;
      const userType = req['user'].sub;
      if (role != 'admin' || userType != 'usave_admin') {
  ...
  async adminGetProductsByStatusAndRange(
    ...
    try {
      ...
      return await this.productService.adminGetProductsByStatusAndRange(
        page,
        limit,
        status,
        startDate,
  ...
  // admin details
  @Get('/details')
  getAdminDetails(@Req() req: Request) {
    const role = req['user'].role;
    const userType = req['user'].sub;
    ...
    return { firstName: 'SuperAdmin', lastName: 'SuperAdmin' };
  }
}
